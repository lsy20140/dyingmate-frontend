...
export function Main_Ground(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Cube001.geometry} material={nodes.Cube001.material} position={[-13.755, 40.569, -241.979]} rotation={[2.746, -1.53, 2.676]} scale={[1.41, 1.554, 1.413]} />
      <mesh geometry={nodes.Cube002.geometry} material={nodes.Cube002.material} position={[-2.11, 25.644, -227.448]} rotation={[0, -1.534, 0]} />
      ...
      <mesh geometry={nodes.Icosphere014.geometry} material={materials.treegreen1} position={[92.043, 33.532, -1.442]} rotation={[0, -0.035, 0.554]} scale={[5.241, 4.496, 6.99]} />
      <mesh geometry={nodes.Cube072.geometry} material={materials.treewood3} position={[90.869, 25.489, -0.864]} rotation={[0, -0.488, 0]} scale={[0.711, 0.983, 0.711]} />
      <mesh geometry={nodes.Icosphere015.geometry} material={materials.treegreen2} position={[70.774, 21.61, -5.351]} rotation={[Math.PI, -0.382, Math.PI]} scale={[1.326, 1.198, 2.449]} />
      <mesh geometry={nodes.Icosphere016.geometry} material={materials.treegreen2} position={[71.444, 21.61, -6.988]} rotation={[Math.PI, -0.452, Math.PI]} scale={[3.479, 3.544, 4.112]} />
      <mesh geometry={nodes.Icosphere017.geometry} material={materials.treegreen2} position={[70.774, 21.61, -5.351]} rotation={[Math.PI, -0.452, Math.PI]} scale={[3.158, 1.886, 4.617]} />
      <mesh geometry={nodes.Cylinder001.geometry} material={materials.treewood1} position={[70.774, 21.61, -5.351]} rotation={[Math.PI, -0.452, Math.PI]} scale={[0.715, 1.476, 0.905]} />
      <mesh geometry={nodes.Cube076.geometry} material={materials.treewood1} position={[70.774, 21.61, -5.351]} rotation={[2.646, 0.258, 3.062]} scale={[0.279, 0.241, 0.949]} />
      <mesh geometry={nodes.Icosphere018.geometry} material={materials.treegreen3} position={[50.79, 52.262, 8.934]} rotation={[0, -0.4, 0]} scale={[4.816, 3.701, 7.041]} />
      <mesh geometry={nodes.Icosphere019.geometry} material={materials.treegreen3} position={[52.764, 50.069, 8.655]} rotation={[0, -0.4, 0]} scale={[6.939, 3.701, 10.145]} />
      <mesh geometry={nodes.Icosphere020.geometry} material={materials.treegreen3} position={[52.764, 44.479, 8.655]} rotation={[0, -0.4, 0]} scale={[8.601, 6.544, 12.575]} />
      <mesh geometry={nodes.Cube077.geometry} material={materials.treewood2} position={[53.503, 28.555, 9.642]} rotation={[0, -0.853, 0]} scale={[0.972, 1.345, 0.972]} />
      <mesh geometry={nodes.Icosphere021.geometry} material={materials.treered1} position={[45.303, 35.453, 2.797]} rotation={[0.251, -1.347, 0.299]} scale={[5.394, 4.104, 7.886]} />
      <mesh geometry={nodes.Icosphere022.geometry} material={materials.treered1} position={[45.073, 38.948, 2.652]} rotation={[0.251, -1.347, 0.299]} scale={[4.351, 2.321, 6.362]} />
      <mesh geometry={nodes.Icosphere023.geometry} material={materials.treered1} position={[44.127, 40.225, 1.689]} rotation={[0.251, -1.347, 0.299]} scale={[3.02, 2.321, 4.415]} />
      <mesh geometry={nodes.Cube078.geometry} material={materials.wood1} position={[45.719, 25.512, 3.943]} rotation={[2.838, -1.323, 2.871]} scale={[0.61, 0.843, 0.61]} />
      ...
      <mesh geometry={nodes.Icosphere036.geometry} material={materials.treegreen2} position={[-54.397, 24.397, -23.448]} rotation={[-0.106, 0.233, 0]} scale={[2.217, 2.004, 4.095]} />
      <mesh geometry={nodes.Cube083.geometry} material={materials.treewood2} position={[-54.397, 24.397, -23.448]} rotation={[0.414, -0.388, -0.003]} scale={[0.466, 0.403, 1.588]} />
      ...
      <mesh geometry={nodes.Icosphere041.geometry} material={materials.treegreen1} position={[-92.396, 42.131, -58.582]} rotation={[-0.057, -0.007, 0.354]} scale={[6.336, 5.626, 6.336]} />
      <mesh geometry={nodes.Cube085.geometry} material={materials.treewood3} position={[-90.041, 25.507, -58.582]} scale={1.385} />
      ...
      <mesh geometry={nodes.Icosphere052.geometry} material={materials.treegreen3} position={[-99.219, 49.357, -124.388]} rotation={[3.059, 0.746, -3.07]} scale={[8.782, 6.682, 12.839]} />
      <mesh geometry={nodes.Cube089.geometry} material={materials.treewood3} position={[-99.184, 37, -124.674]} rotation={[2.973, 1.198, -2.997]} scale={[0.993, 1.373, 0.993]} />
      ...
      <mesh geometry={nodes.trees007.geometry} material={materials['minitree2.001']} position={[80.044, 26.305, -3.439]} rotation={[-3.121, 0.238, 3.056]} scale={[0.452, 0.62, 0.452]} />
      ...
      <group position={[-20.511, 45.012, 2.799]} rotation={[0, 1.326, 0]}>
        <mesh geometry={nodes.Cube008.geometry} material={materials.HOUSE1} />
        <mesh geometry={nodes.Cube008_1.geometry} material={materials['HOUSE1.001']} />
        <mesh geometry={nodes.Cube008_2.geometry} material={materials['HOUSE1.002']} />
      </group>
      <mesh geometry={nodes.Cube018.geometry} material={nodes.Cube018.material} position={[-25.763, 27.591, -13.022]} rotation={[0, 1.326, 0]} />
      <mesh geometry={nodes.Cube019.geometry} material={nodes.Cube019.material} position={[-27.864, 27.591, -13.546]} rotation={[0, 1.326, 0]} />
      <mesh geometry={nodes.Cube020.geometry} material={nodes.Cube020.material} position={[-30.081, 27.591, -14.1]} rotation={[0, 1.326, 0]} />
      <mesh geometry={nodes.Cube021.geometry} material={nodes.Cube021.material} position={[-28.033, 26.187, -13.594]} rotation={[0, 1.326, 0]} />
      <mesh geometry={nodes.Cube022.geometry} material={nodes.Cube022.material} position={[-38.031, 24.963, -9.886]} rotation={[-Math.PI, 0.245, -Math.PI]} />
      <mesh geometry={nodes.Cube023.geometry} material={nodes.Cube023.material} position={[-38.536, 26.367, -7.838]} rotation={[-Math.PI, 0.245, -Math.PI]} />
      <mesh geometry={nodes.Cube024.geometry} material={nodes.Cube024.material} position={[-37.983, 26.367, -10.054]} rotation={[-Math.PI, 0.245, -Math.PI]} />
      <mesh geometry={nodes.Cube025.geometry} material={nodes.Cube025.material} position={[-37.458, 25.676, -12.155]} rotation={[-Math.PI, 0.245, -Math.PI]} />
